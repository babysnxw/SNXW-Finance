...
IncomeRecord _incomeRecordDeserialize(
  ...
  object.recurrence = reader.readStringOrNull(offsets[3]);
...
extension IncomeRecordQueryFilter
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> amountEqualTo(
    double value, {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> amountBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> notesEqualTo(
    String? value, {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> notesLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> notesBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> notesEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> notesContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> notesMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> sourceEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> sourceBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterFilterCondition> sourceMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension IncomeRecordQuerySortBy
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> sortByAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'amount', Sort.asc);
    });
  }

  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> sortByAmountDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> sortByNotes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.asc);
    });
  }

  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> sortByNotesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.desc);
    });
  }

  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> sortByRecurrence() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> sortBySource() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'source', Sort.asc);
    });
  }

  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> sortBySourceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension IncomeRecordQuerySortThenBy
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> thenByAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'amount', Sort.asc);
    });
  }

  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> thenByAmountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'amount', Sort.desc);
    });
  }
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> thenByNotes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.asc);
    });
  }

  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> thenByNotesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.desc);
    });
  }

  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> thenByRecurrence() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recurrence', Sort.asc);
    });
  }
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> thenBySource() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'source', Sort.asc);
    });
  }

  QueryBuilder<IncomeRecord, IncomeRecord, QAfterSortBy> thenBySourceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'source', Sort.desc);
    });
  }
...
extension IncomeRecordQueryWhereDistinct
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QDistinct> distinctByAmount() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QDistinct> distinctByNotes(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QDistinct> distinctByRecurrence(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IncomeRecord, IncomeRecord, QDistinct> distinctBySource(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension IncomeRecordQueryProperty
  ...
  QueryBuilder<IncomeRecord, double, QQueryOperations> amountProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IncomeRecord, String?, QQueryOperations> notesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'notes');
    });
  }

  QueryBuilder<IncomeRecord, String?, QQueryOperations> recurrenceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'recurrence');
    });
  }

  QueryBuilder<IncomeRecord, String, QQueryOperations> sourceProperty() {
    return QueryBuilder.apply(this, (query) {
